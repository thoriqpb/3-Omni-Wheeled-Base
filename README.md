# 3 Omni-wheeled Base🎮
This program controls a 3 omni-wheeled base robot using BNO055 orientation angle feedback. My team and I utilized the ESP32 as the microcontroller and the IBT2 motor driver for controlling PG45 motor DC. Since we didn't use motor encoders, we opted for PWM as the output instead of motor speed (𝑉𝑖). Our focus was on experimenting with PID control for the BNO055 alongside the 3 omni-wheeled base.
